...
#print("datas_train shape: {}")(np.array(datas_train).shape)
    #print("datas_test shape: {}")(np.array(datas_test).shape)
...
class LSTM(nn.Module):
    ...
    def forward(self, images, prints=False):
        ...
        # print('hidden_state t0 shape:', hidden_state.shape, '\n' +
        ...
        #print('FNN: Final output shape:', output.shape)
