...
class Preprocess():
    ...
    def __getitem__(self,idx_seq: int) -> Tuple[torch.Tensor, int]:
        # print("idx_seq :")
        # print(idx_seq)
        # y_train = torch.tensor(np.array(self.y_train)[idx_seq])
        # y_test = self.y_test[int(idx_seq)]
        if(idx_seq == "X_train"): return self.X_train
        elif(idx_seq == "X_test"): return self.X_test
        elif(idx_seq == "y_train"): return self.y_train
        elif(idx_seq == "y_test"): return self.y_test
        else :
